...
error through the minimum Mean Square Error. See Fig \ref{fig:GRF_error}
for more details
...
This is an individual task, your job is the following: 1. Perform the
best ML algorithm that fits the Test set greater than 0.92. Remind the
...
needed to provide coherent results. (40\% of the grade) 2. Perform
Sensitivity analysis procedure: Do this analysis with the following
techniques:
\href{https://scikit-learn.org/dev/auto_examples/inspection/plot_permutation_importance.html}{Permutation
importance, feature importance} and one the
\href{https://salib.readthedocs.io/en/latest/}{Salib packages}. Compare
the results and give conclusions. (20\% of the grade) 3. Generate an
estrategy for obtaining the best values. For instance, you can set a
...
goals and preserving the constrains. (10\% of the grade) 4. Provide 5
new samples, I will simulate your dimensions and see how far are from
the predicted answers (10\% of the grade). 5. Presentation and
visualization: Remind that good plots and coherent conslusions makes
...
{[}Forrester2008{]} Alexander I J Forrester, Andr\{'\{a\}\}s
S\{'\{o\}\}bester and Andy J Keane, ``\emph{Engineering Design via
surrogate optimization}'\,', 2008.

{[}Iooss2015{]} Iooss Bertrand and Lema\{\^{}\{i\}\}tre Paul,
``\emph{Uncertainty Management in Simulation-Optimization of Complex
Systems}'\,', Operations Research/ Computer Science Interfaces Series,
vol.~59, number , pp.~101--122, 2015.
\href{http://www.researchgate.net/publication/261512645_A_review_on_global_sensitivity_analysis_methods}{online}

{[}Hansen2016{]} Hansen Andrew and Starker Felix, ``\emph{Prosthetic
Foot Principles and Their Influence on Gait}'\,', Handbook of Human
Motion, vol.~, number , pp.~1--15, 2016.
